            ...
            "properties": {
                ...
                "learn": {
                    ...
                    "properties": {
                        ...
                        "knowledge_service_url": {"type": "string", "description": "Internal Learn Knowledge Service base URL."},
                        "knowledge_service_scope": {"type": "string", "description": "Scope for DefaultAzureCredential token acquisition."},
                        "knowledge_search_path": {"type": "string", "description": "Internal Learn search endpoint path (default: /api/search)."},
                    },
                },
            },
        },
